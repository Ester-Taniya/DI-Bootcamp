'''___Exercises XP 3_____________________________________________________________________________________________________________________________________'''
import random
#1
...
#4
    ...
    def do_a_trick(self):
        ...
        else: print(f'{self.name}, cant do a trick,because not traned!')
